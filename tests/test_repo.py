...
class TheCallCardThatWasPromisedBeforeItExisted(unittest.TestCase):
    ...
    PROMISED = [
        ...
        ('what to ask for at the end - "please send me this in writing"',
         ['"please send me this in writing."', "The letter is the evidence"]),
        ("what to do after the call: what was achieved and the next step",
         ["After the call:", "what was achieved, and the next step"]),
